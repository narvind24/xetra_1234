...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_access_key = 'AKIAY33FTLLDFGJICA5K'
        self.s3_secret_key = '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'
        self.s3_endpoint_url = 'https://s3.eu-central-1.amazonaws.com'
        self.s3_bucket_name_src = 'xetra-int-test-src-123'
        self.s3_bucket_name_trg = 'xetra-int-test-trg-123'
